...
def get_scheduled_tasks():
    ...
    try:
        ...
        result = get_supabase_client().table('scheduled_tasks').select('*').order('created_at', desc=True).execute()
...
def create_scheduled_task():
    ...
    try:
        ...
        # Insert task
        result = get_supabase_client().table('scheduled_tasks').insert(task_data).execute()
